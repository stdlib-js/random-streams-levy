...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a Lévy distribution.
*/
declare class RandomStream extends Readable {
	...
	*/
	constructor( mu: number, c: number, options?: Options );
	...
	*/
	...
	/**
	* Pseudorandom number generator for generating pseudorandom numbers drawn from a Lévy distribution.
	*/
...
interface Constructor {
	...
	* stream.pipe( inspectStream( log )  );
	*/
	new( mu: number, c: number, options?: Options ): RandomStream; // newable
	...
	* stream.pipe( inspectStream( log )  );
	*/
	( mu: number, c: number, options?: Options ): RandomStream; // callable
	...
	* }
	*/
	factory( options?: Options ): ( mu: number, c: number ) => RandomStream;

	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a Lévy distribution.
	*
	* @param mu - mean
	* @param c - scale parameter
	* @param options - stream options
	...
	*/
	objectMode( mu: number, c: number, options?: Options ): RandomStream;
}
