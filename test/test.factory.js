...
tape( 'the function returns a function which throws an error if scale parameter `c` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function returns a function which throws an error if scale parameter `c` is not a positive number primitive (parameters)', function test( t ) {
	var values;
	var i;
