...
tape( 'the function throws an error if scale parameter `c` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Levy distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Levy distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
